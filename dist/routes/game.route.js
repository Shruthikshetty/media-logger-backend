...
route.post(
  ...
  (0, handle_validation_1.validateReq)(add_game_1.AddGameZodSchema),
  game_controller_1.addGame
);
/**
 * @swagger
 * /api/game/filter:
...
route.post(
  '/filter',
  (0, handle_validation_1.validateReq)(games_filter_1.GamesFilterZodSchema),
  game_controller_1.filterGames
);
/**
 * @swagger
 * /api/game/bulk:
...
route.post(
  ...
  (0, handle_json_file_validation_1.ValidateJsonFile)(
    bulk_add_1.BulkAddGameZodSchema
  ),
  game_controller_1.bulkAddGames
);
/**
 * @swagger
 * /api/game/bulk:
...
route.delete(
  '/bulk',
  (0, require_auth_1.requireAuth)('admin'),
  (0, handle_validation_1.validateReq)(bulk_delete_1.BulkDeleteGameZodSchema),
  game_controller_1.bulkDeleteGames
);
/**
 * @swagger
 * /api/game/{id}:
...
route.delete(
  '/:id',
  (0, require_auth_1.requireAuth)('admin'),
  game_controller_1.deleteGameById
);
/**
 * @swagger
 * /api/game/{id}:
...
route.patch(
  '/:id',
  (0, require_auth_1.requireAuth)('admin'),
  (0, handle_validation_1.validateReq)(update_game_1.UpdateGameZodSchema),
  game_controller_1.updateGameById
);
