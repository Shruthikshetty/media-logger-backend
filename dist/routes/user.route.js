...
route.post(
  '/',
  (0, handle_validation_1.validateReq)(add_user_1.AddUserZodSchema),
  user_controller_1.addUser
);
/**
 * @swagger
 * /api/user:
...
route.get(
  '/',
  (0, require_auth_1.requireAuth)(),
  user_controller_1.getUserDetail
);
/**
 * @swagger
 * /api/user/all:
...
route.patch(
  '/',
  (0, require_auth_1.requireAuth)(),
  (0, handle_validation_1.validateReq)(update_user_1.UpdateUserZodSchema),
...
route.put(
  '/role/:id',
  (0, require_auth_1.requireAuth)('admin'),
  (0, handle_validation_1.validateReq)(update_role_1.UpdateRoleZodSchema),
  user_controller_1.updateRoleById
);
