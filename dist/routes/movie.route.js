...
route.post(
  '/filter',
  (0, handle_validation_1.validateReq)(movie_filters_1.MovieFiltersZodSchema),
  movie_controller_1.getMoviesWithFilters
);
/**
 * @swagger
 * /api/movie/{id}:
...
route.post(
  ...
  (0, handle_validation_1.validateReq)(add_movie_1.AddMovieZodSchema),
  movie_controller_1.addMovie
);
/**
 * @swagger
 * /api/movie/bulk:
...
route.post(
  ...
  (0, handle_json_file_validation_1.ValidateJsonFile)(
    bulk_add_1.BulkAddMovieZodSchema
  ),
  movie_controller_1.addBulkMovies
);
/**
 * @swagger
 * /api/movie/bulk:
...
route.delete(
  '/bulk',
  (0, require_auth_1.requireAuth)('admin'),
  (0, handle_validation_1.validateReq)(bulk_delete_1.BulkDeleteMovieZodSchema),
  movie_controller_1.bulkDeleteMovies
);
/**
 * @swagger
 * /api/movie/{id}:
...
route.delete(
  '/:id',
  (0, require_auth_1.requireAuth)('admin'),
  movie_controller_1.deleteMovieById
);
/**
 * @swagger
 * /api/movie/{id}:
...
route.patch(
  '/:id',
  (0, require_auth_1.requireAuth)('admin'),
  (0, handle_validation_1.validateReq)(update_movie_1.updateMoveZodSchema),
  movie_controller_1.updateMovieById
);
