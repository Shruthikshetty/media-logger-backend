...
const media_entry_route_1 = __importDefault(require("./media-entry.route"));
const discover_route_1 = __importDefault(require("./discover.route"));
//initialize router
...
route.use('/media-entry', media_entry_route_1.default);
//discover media route
route.use('/discover', discover_route_1.default);
