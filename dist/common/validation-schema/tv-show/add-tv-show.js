...
exports.AddTvShowZodSchema = zod_1.default.object({
  ...
  cast: zod_1.default
    ...
    .optional(),
  directors: zod_1.default.array(
    zod_1.default.string({ message: 'Directors must be string' }),
    {
  ...
  ageRating: zod_1.default
    ...
    .optional(),
  seasons: zod_1.default
    .array(add_season_1.AddSeasonZodSchema.omit({ tvShow: true }))
    .optional(),
});
