 ...
 */
const getSeasonsWithEpisodes = (tvShowId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const seasonsWithEpisodes = yield Promise.all(seasons.map((season) => __awaiter(void 0, void 0, void 0, function* () {
        const episodes = yield tv_episode_1.default.find({ season: season._id }).lean().exec();
 ...
 */
const getTvShowDetails = (fullDetails, start, limit) => __awaiter(void 0, void 0, void 0, function* () {
    if (fullDetails === 'true') {
        ...
        const tvShowsWithDetails = yield Promise.all(tvShows.map((tvShow) => __awaiter(void 0, void 0, void 0, function* () {
            const seasonsWithEpisodes = yield (0, exports.getSeasonsWithEpisodes)(tvShow._id);
            return Object.assign(Object.assign({}, tvShow), { seasons: seasonsWithEpisodes });
        })));
