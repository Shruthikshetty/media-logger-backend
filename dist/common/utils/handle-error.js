...
const handleError = (res, options) => {
  ...
  const statusCode =
    (_a =
      options === null || options === void 0 ? void 0 : options.statusCode) !==
      null && _a !== void 0
      ? _a
      : 500;
  // set default message configured above
  const message =
    (_b = options === null || options === void 0 ? void 0 : options.message) !==
      null && _b !== void 0
      ? _b
  ...
  if (
    ...
    (options === null || options === void 0 ? void 0 : options.error)
  ) {
