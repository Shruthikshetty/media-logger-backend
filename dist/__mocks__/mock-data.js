...
exports.createMockEpisode = exports.mockTestSeason = exports.invalidGames = exports.mockTestGamesSet2 = exports.mockTestMovies = exports.mockTestGames = exports.mockTestUsers = void 0;
const mongoose_1 = require("mongoose");
const model_constants_1 = require("../common/constants/model.constants");
exports.mockTestUsers = [
...
exports.mockTestGames = Array.from({ length: 5 }).map((_, i) => ({
...
exports.mockTestMovies = Array.from({ length: 10 }).map((_, i) => ({
...
exports.mockTestSeason = {
    _id: new mongoose_1.Types.ObjectId(), // Random ObjectId
    tvShow: new mongoose_1.Types.ObjectId(),
    seasonNumber: 1,
