...
exports.bulkAddTvShow =
  exports.filterTvShow =
  exports.searchTvShow =
  exports.bulkDeleteTvShow =
  exports.deleteTvShowById =
  exports.updateTvShowById =
  exports.getTvShowById =
  exports.getAllTvShows =
  exports.addTvShow =
    void 0;
...
const addTvShow = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      // save the tv show
      const savedTvShow = yield (0, add_tv_show_1.addSingleTvShow)(
        req.validatedData,
        session
      );
      ...
      (0, handle_error_1.handleError)(res, {
        ...
        message:
          ...
          (0, mongo_errors_1.isDuplicateKeyError)(error)
...
const getAllTvShows = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { limit, start } = (0, pagination_1.getPaginationParams)(
      req.query,
      config_constants_1.GET_ALL_TV_SHOW_LIMITS
    );
    try {
      //get all the tv shows
      const [tvShows, total] = yield (0, get_tv_show_1.getTvShowDetails)(
        req.query.fullDetails,
        start,
        limit
      );
      // get pagination details
      const pagination = (0, pagination_1.getPaginationResponse)(
        total,
        limit,
        start
      );
...
const getTvShowById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      get_tv_show_1.getSeasonsWithEpisodes)(tvShow._id);
      // return the tv show with seasons and episodes
      res.status(200).json({
        success: true,
        data: {
          tvShow: Object.assign(Object.assign({}, tvShow), {
...
const updateTvShowById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const updatedTvShow = yield tv_show_mode_1.default
        .findByIdAndUpdate(id, req.validatedData, { new: true })
        .lean()
        .exec();
...
const deleteTvShowById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      // delete tv show
      const { deletedCount } = yield (0, delete_tv_show_1.deleteTvShow)(
        id,
        session
      );
...
const bulkDeleteTvShow = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      for (const id of tvShowIds) {
        // delete tv show
        const { deletedCount: receivedDeletedCount } = yield (0,
        delete_tv_show_1.deleteTvShow)(id, session);
        //update count
...
const searchTvShow = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      //get the tv shows
      const tvShows = yield tv_show_mode_1.default
        .aggregate(pipeline)
        .limit(limit)
        .skip(start)
        .exec();
...
const filterTvShow = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const data =
        (_a = result[0]) === null || _a === void 0 ? void 0 : _a.data;
      const totalCount =
        ((_c =
          (_b = result[0]) === null || _b === void 0
            ? void 0
            : _b.totalCount[0]) === null || _c === void 0
          ? void 0
          : _c.total) || 0;
      const pagination = (0, pagination_1.getPaginationResponse)(
        totalCount,
