...
exports.filterGames =
  exports.searchGame =
  exports.bulkDeleteGames =
  exports.bulkAddGames =
  exports.updateGameById =
  exports.deleteGameById =
  exports.addGame =
  exports.getGameById =
  exports.getAllGames =
    void 0;
...
const getAllGames = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { limit, start } = (0, pagination_1.getPaginationParams)(
      req.query,
      config_constants_1.GET_ALL_GAMES_LIMITS
    );
    try {
      //find all the games
      const [games, total] = yield Promise.all([
        game_model_1.default
          .find()
          .skip(start)
          .limit(limit)
          .sort({ createdAt: -1 })
...
const deleteGameById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      // check if id is a valid mongo id
      if (
        !(0, mongo_errors_1.isMongoIdValid)(
      ...
      // delete the game
      const deletedGame = yield game_model_1.default
        .findByIdAndDelete(
          (_b = req.params) === null || _b === void 0 ? void 0 : _b.id
        )
        .lean()
        .exec();
...
const updateGameById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const updatedGame = yield game_model_1.default
        .findByIdAndUpdate(
          (_b = req.params) === null || _b === void 0 ? void 0 : _b.id,
          req.validatedData,
          {
...
const searchGame = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // get the games
      const games = yield game_model_1.default
        .aggregate(pipeline)
        .limit(limit)
        .skip(start)
        .exec();
