...
exports.updateEpisodeById =
  exports.deleteEpisodeById =
  exports.getEpisodeById =
  exports.addEpisode =
    void 0;
...
const addEpisode = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const season = yield tv_season_1.default
        .findById(req.validatedData.season)
        .lean()
        .exec();
      if (!season) {
      ...
      (0, handle_error_1.handleError)(res, {
        error: err,
        statusCode:
          (err === null || err === void 0 ? void 0 : err.statusCode) || 500,
...
const getEpisodeById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const episode = yield (0, get_episode_1.getEpisodeDetailsById)(
        id,
        fullDetails
      );
...
const deleteEpisodeById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // get id from params
      const { id } = req.params;
      ...
      //delete the episode
      const deletedEpisode = yield tv_episode_1.default
...
const updateEpisodeById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // get id from params
      const { id } = req.params;
      ...
      const updatedEpisode = yield tv_episode_1.default
