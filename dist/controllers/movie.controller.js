...
exports.getMoviesWithFilters =
  exports.searchMovies =
  exports.addBulkMovies =
  exports.bulkDeleteMovies =
...
const getAllMovies = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { limit, start } = (0, pagination_1.getPaginationParams)(
      req.query,
      config_constants_1.GET_ALL_MOVIES_LIMITS
    );
    try {
...
const deleteMovieById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // delete the movie
      const deletedMovie = yield movie_model_1.default
...
const updateMovieById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // update the movie
      const updatedMovie = yield movie_model_1.default
        .findByIdAndUpdate(id, req.validatedData, {
          new: true,
        })
        .lean()
        .exec();
...
const bulkDeleteMovies = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // get movie ids
...
const addBulkMovies = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // continue inserting even if there are errors
      const savedMovies = yield movie_model_1.default.insertMany(
        req.validatedData,
        {
          ordered: false,
      ...
      const notAdded = (
        err === null || err === void 0 ? void 0 : err.writeErrors
      )
        ? err.writeErrors.map((e) => {
            var _a, _b, _c, _d;
            return (_d =
              (_b = (_a = e.err) === null || _a === void 0 ? void 0 : _a.op) !==
                null && _b !== void 0
                ? _b
                : (_c = e.err) === null || _c === void 0
                  ? void 0
                  : _c.doc) !== null && _d !== void 0
              ? _d
              : {};
          })
        : [];
      ...
      const added =
        (err === null || err === void 0 ? void 0 : err.insertedDocs) || [];
...
const searchMovies = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // search for movies
      const movies = yield movie_model_1.default
        .aggregate(pipeline)
        .limit(limit)
        .skip(start);
      // return the movies
...
const getMoviesWithFilters = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
