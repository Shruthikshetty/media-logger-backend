...
const getAllUsers = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { limit, start } = (0, pagination_1.getPaginationParams)(
      req.query,
      config_constants_1.GET_ALL_USER_LIMITS
    );
    try {
...
const deleteUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      //delete the user
      const deletedUser = yield user_model_1.default
        .findByIdAndDelete(req.userData._id)
        .select('-password')
        .lean()
        .exec();
...
const deleteUserById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const { id } = req.params;
      // validate if
      const isValidId = delete_user_1.DeleteUserZodSchema.safeParse({
        id,
      }).success;
      if (!isValidId) {
        (0, handle_error_1.handleError)(res, {
...
const updateUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (
        (_a = req.validatedData) === null || _a === void 0
          ? void 0
          : _a.password
      ) {
...
const updateRoleById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // update the role
      const updatedRole = yield user_model_1.default
        .findByIdAndUpdate(
          id,
          { role },
          {
