...
describe('Movie update endpoints PATCH /api/movie/:id', () => {
  ...
  describe('Successful movie updates', () => {
    it('should update a movie with all valid fields', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const updateData = {
    ...
    it('should update movie with partial data (only title)', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
  ...
  describe('Validation error tests', () => {
    ...
    it('should return 400 for invalid average rating (above 10)', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
    ...
    it('should return 400 for invalid tags', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
    ...
    it('should return 400 for invalid release date format', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
  ...
  describe('Resource not found tests', () => {
    ...
    it('should return 400 for invalid movie ID format', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
  ...
  describe('Edge cases and data transformation', () => {
    it('should transform languages to lowercase', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        // Log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
