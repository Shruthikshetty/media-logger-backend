...
describe('Movie API Integration Tests GET /api/movie', () => {
    ...
    describe('get specific movie GET /api/movie/:id', () => {
        it('should return specific movie', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/movie/${movieId}`);
            //assertions
            expect(res.status).toBe(200);
            expect(res.body.success).toBe(true);
        ...
        it('should return 404 if movie not found', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/movie/${new mongoose_1.default.Types.ObjectId()}`);
        ...
        it('should return 400 if invalid movie id', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/movie/invalid-id`);
