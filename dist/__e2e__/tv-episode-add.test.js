...
describe('tv episode add related endpoints POST /api/tv-show/episode', () => {
  ...
  beforeAll(() =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      // add a mock season
      const season = yield tv_season_1.default.create(
        mock_data_1.mockTestSeason
      );
  ...
  it('should add a new episode to a season', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // log in as admin
      yield loginUser();
  ...
  it('should return 400 if season id is invalid', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      //log in as admin
      yield loginUser();
      const res = yield (0, supertest_1.default)(__1.app)
        .post(`/api/tv-show/episode`)
        .send(
          (0, mock_data_1.createMockEpisode)({ season: 'invalid-season-id' })
        )
        .set('Authorization', `Bearer ${token}`);
      expect(res.status).toBe(400);
      expect(res.body.success).toBe(false);
  ...
  it("should return 400 if season doesn't exist", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      //log in as admin
      yield loginUser();
      const res = yield (0, supertest_1.default)(__1.app)
        .post(`/api/tv-show/episode`)
        .send(
          (0, mock_data_1.createMockEpisode)({
            season: new mongoose_1.default.Types.ObjectId(),
          })
        )
        .set('Authorization', `Bearer ${token}`);
