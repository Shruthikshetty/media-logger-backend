...
describe('all games get related endpoints ', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const games = yield game_model_1.default.insertMany(mock_data_1.mockTestGames);
    ...
    describe('get all games  GET /api/game', () => {
        it('should return all games', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('get specific games GET /api/game/:id', () => {
        it('should return specific game', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/game/${gameId}`);
            expect(res.status).toBe(200);
            expect(res.body.success).toBe(true);
        ...
        it('should return 404 if game not found', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/game/${new mongoose_1.default.Types.ObjectId()}`);
        ...
        it('should return 400 if invalid game id', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).get(`/api/game/invalid-id`);
