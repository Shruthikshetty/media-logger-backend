...
describe('movies delete related endpoints', () => {
    ...
    describe('single delete using id DELETE /api/movie/:id', () => {
        it('should allow an admin to delete a movie', () => __awaiter(void 0, void 0, void 0, function* () {
            yield loginUser();
        ...
        it('should reject deletion when unauthenticated', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).delete(`/api/movie/${movieId1}`);
            expect(res.status).toBe(401);
            expect(res.body.success).toBe(false);
            expect(res.body.message).toMatch(/Unauthorized/);
        }));
        it('should return 404 if movie not found', () => __awaiter(void 0, void 0, void 0, function* () {
            //log in as admin
            yield loginUser();
            const res = yield (0, supertest_1.default)(__1.app)
        ...
        it('should return 400 if invalid movie id', () => __awaiter(void 0, void 0, void 0, function* () {
            //log in as admin
            yield loginUser();
            const res = yield (0, supertest_1.default)(__1.app)
    ...
    describe('bulk delete using ids DELETE /api/movie/bulk', () => {
        it('should allow an admin to delete multiple movies', () => __awaiter(void 0, void 0, void 0, function* () {
            yield loginUser();
            // delete the first movie
            const res = yield (0, supertest_1.default)(__1.app)
        ...
        it('should reject bulk deletion when unauthenticated', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield (0, supertest_1.default)(__1.app).delete(`/api/movie/bulk`);
            expect(res.status).toBe(401);
            expect(res.body.success).toBe(false);
            expect(res.body.message).toMatch(/Unauthorized/);
        }));
        ...
        it('it should return 200 in case of partial delete when one of the ids is not existing ', () => __awaiter(void 0, void 0, void 0, function* () {
            //log in as admin
            yield loginUser();
            const res = yield (0, supertest_1.default)(__1.app)
                .delete(`/api/movie/bulk`)
