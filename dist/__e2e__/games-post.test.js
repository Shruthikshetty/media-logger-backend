...
describe('Game creation POST /api/game', () => {
  ...
  describe('Games add bulk games POST /api/game/bulk', () => {
    it('should create multiple games successfully', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //log in as admin
        yield loginUser();
        ...
        (0, fs_1.writeFileSync)(
          filePath,
          JSON.stringify(mock_data_1.mockTestGamesSet2),
          'utf-8'
        );
        try {
          //call endpoint
          ...
          expect(Array.isArray(res.body.data.notAdded)).toBe(true);
          expect(res.body.data.notAdded.length).toBe(0);
        } finally {
          //clean up
          (0, fs_1.unlinkSync)(filePath);
        }
      }));
    it('should throw 400 for invalid validation error', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //log in as admin
        yield loginUser();
        // Construct the file path to your mock JSON data
        ...
        (0, fs_1.writeFileSync)(
          filePath,
          JSON.stringify(mock_data_1.invalidGames),
          'utf-8'
        );
        try {
          //call endpoint
    ...
    it('should show No file uploaded. Please upload a JSON file', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //log in as admin
        yield loginUser();
        const res = yield (0, supertest_1.default)(__1.app)
