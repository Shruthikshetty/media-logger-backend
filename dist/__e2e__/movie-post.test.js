...
describe('POST /api/movie', () => {
  ...
  describe('Add single movie POST /api/movie', () => {
    it('should create a new movie when given valid data', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const movieData = {
          title: 'Inception',
    ...
    it('should return a 400 validation error if the title is missing', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const movieData = {
    ...
    it('should return 401 for unauthenticated user', () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_2.default)(index_1.app)
          .post('/api/movie')
          .send({});
